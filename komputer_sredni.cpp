...
/** \brief Rozgrywka z komputerem (poziom sredni).
*
* Funkcja umozliwia rozgrywke z komputerem na poziomie srednim - komputer potrafi wykonac zwycieski ruch i sie bronic - inne ruchy sa losowe.
